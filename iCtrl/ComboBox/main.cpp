...
VOID KeyEventProc(KEY_EVENT_RECORD ker)
{
	...
	if (ker.bKeyDown)
	{
		...
		//	if (on)
		//	{
		//		cBox.setCellActive(0, cur);
		//		for (i = 0; i < cBox.cBoxSize(); i++)
		//		{
		//			if ((cBox.isCellActive(i) == true) && (i > 0))
		//			{
		//				cBox.setCellActive(i, cur);
		//				cBox.cellCoordinator(i, cur, "up");
		//				cBox.setCellActive(i - 1, cur);
		//				break;
		//			}
		//		}
		//	}
		...
		//		for (i = 0; i < cBox.cBoxSize(); i++)
		//		{
		//			if ((cBox.isCellActive(i) == true) && (i + 1 < cBox.cBoxSize()))
		//			{
		//				cBox.setCellActive(i, cur);
		//				cBox.cellCoordinator(i, cur, "down");
		//				cBox.setCellActive(i + 1, cur);
		//				break;
		//			}
		//		}
