...
ComboBox::ComboBox(int width, vector<string> entries) : Panel((entries.size() * 2), width),label(" "), BoxHeader(10, label), listen(*this), button(5)
{
	setLocation(0, 0);
	...
	for (int i = 0; i < boxList.size(); i++)
	{
		...
		Panel::AddControler(BoxHeader, 0, 0);
